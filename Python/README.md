...
O objetivo desta pasta é ter um conjunto de **apontamentos estruturados + exercícios graduais**, que os alunos possam usar como:
...
-   [`00_formulario_apoio.md`](#00_formulario_apoiomd)
-   [`00_exercicios_de_preparacao.md`](#00_exercicios_de_preparacaomd)
...
-   [`06_slicing_list_comprehensions.md`](#06_slicing_list_comprehensionsmd)
...
-   [`11_projeto_final_python.md`](#11_projeto_final_pythonmd)
...
[Ver ficheiro](./00_formulario_apoio.md)

**Objetivo:**  
Servir como ficha de consulta rápida para testes, com exemplos curtos e lembretes de sintaxe essencial.

Conteúdos principais:

-   entrada/saída, conversões e operadores;
-   condicionais, ciclos e padrões frequentes;
-   listas, dicionários e estruturas aninhadas;
-   funções, slicing/comprehensions e ficheiros.
...
**Objetivo:**  
Descrever o projeto final do módulo: criação de um quiz em consola, com requisitos, regras e níveis de melhoria.

Conteúdos principais:

-   contexto, objetivos e organização do trabalho em grupo;
-   estrutura do ficheiro `perguntas.json` e validações básicas;
-   funcionalidades obrigatórias (MVP) e extensões opcionais;
-   boas práticas de modularização e robustez.

---

## Como usar estes materiais

1. Usa o `00_formulario_apoio.md` como ficha rápida de consulta.
2. Segue a **ordem dos ficheiros** (01 → 02 → 03 → 04 → 05 → 06 → 07 → 08 → 09 → 10) e intercala o `00_exercicios_de_preparacao.md` para revisão.
3. Em cada ficheiro:
...
4. Depois de dominares 01–10, aplica os conhecimentos no `11_projeto_final_python.md`.
